...
def functionCopyFromRegression(X_train, X_test, y_train, y_test):
    #fit_Ridge function
...
def desc_calc(data) -> pd.DataFrame: # fill the necessary arguments
    getAllDescriptors(data, mode='train', log=None)
...
if __name__ == "__main__":
    ...
    # loading data
    train_data = pd.read_csv('logp_100.csv', sep=',')
    pred_data = pd.read_csv('logp_inputs.csv', sep=',')
