...
def desc_calc(data, mode='train') -> pd.DataFrame: # fill the necessary arguments
...
def sar_model_train(descriptors_train: pd.DataFrame, indices):
    ...
    model = Pipeline([('impute', a), ('scaling', b), ('rf', clf)]) # with ANOVA now
...
if __name__ == "__main__":
    ...
    # I've not understood what should be done exactly on this step
